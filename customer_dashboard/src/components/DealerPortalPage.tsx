...
import {
  ...
  ShoppingBag, User, RefreshCw, Tag, Award,
...
import type { DealerApplicationStatus } from '../services/dealer';
      ...
      <div className="bg-white border border-slate-100 rounded-2xl shadow-sm overflow-hidden">
        ...
        <div className="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <InfoField
            ...
            mono
          />
          <InfoField label="Member Since" value={fmt(profile?.created_at ?? undefined)} icon={<Calendar className="w-3.5 h-3.5" />} />
        </div>
      </div>
